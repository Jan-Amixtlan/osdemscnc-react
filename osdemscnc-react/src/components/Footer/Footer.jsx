          ...
          <div className={styles.footerSection}>
            ...
            <div className={styles.addressInfo} style={{ gap: '1px' }}>
              ...
              <div className={styles.contactItem} style={{ marginBottom: '1px' }}>
                ...
                <a href="tel:+52332622591" className={styles.contactLink}>+52 33 2622 5912</a>
              </div>
              <div className={styles.contactItem}>
                ...
                <a href="mailto:contact@osdemscnc.com" className={styles.contactLink}>contact@osdemscnc.com</a>
              </div>
            </div>
          </div>
          ...
          <div className={styles.footerSection}>
            ...
            <div className={styles.socialNetworks} style={{ gap: '1px' }}>
              <a 
                ...
                className={`${styles.socialItem} ${hoveredSocial === 'facebook' ? styles.socialHovered : ''}`}
              ...
              >
                ...
                <span>Osdems CNC</span>
              </a>
              <a 
                href="https://www.instagram.com/_parts.cnc_/?igshid=MzMyNGUyNmU2YQ%3D%3D" 
                target="_blank" 
                rel="noopener noreferrer" 
                className={`${styles.socialItem} ${hoveredSocial === 'instagram' ? styles.socialHovered : ''}`}
              ...
              >
                ...
                <span>_parts.cnc_</span>
              </a>
              <a 
                href="https://www.youtube.com/channel/UCzpFRl3eZQpBrdMwD-BHJdA" 
                target="_blank" 
                rel="noopener noreferrer" 
                className={`${styles.socialItem} ${hoveredSocial === 'youtube' ? styles.socialHovered : ''}`}
              ...
              <a 
                href="https://www.linkedin.com/company/osdems-cnc/posts/?feedView=all" 
                target="_blank" 
                rel="noopener noreferrer" 
                className={`${styles.socialItem} ${hoveredSocial === 'linkedin' ? styles.socialHovered : ''}`}
